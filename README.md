...
# What is it?
QL Server is as backend server, which supports queries, like [GraphQL](http://graphql.org), but much simpler to understand, as the queries are JSON objects  with a specific syntax, which is documented below.
